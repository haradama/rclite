...
TARGETS = [
    ...
    ("wasm32-unknown-unknown", "", "+simd128"),  # WASM SIMD ISA (kernel scalar)
]
...
def _affine_qm():
    rc = ReservoirComputer(
        ...
        reservoir=ReservoirNode(units=16, topology=Topology.ESN_STANDARD,
                                leak_rate=0.3, density=0.2, seed=4, name="res"),
