...
from rclite.quant import (
    search_quantization, TanhLUTSpec, I32FixedPoint,
)
...
BUILD = pathlib.Path(__file__).resolve().parent.parent / "build" / "microbit_q"
...
def main() -> None:
    ...
    artifact = target.compile_quantized(
        qmodel, output_dir=BUILD, test_inputs=sample_X,
    )
